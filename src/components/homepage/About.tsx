    ...
    return (
        <>
            <div className='bg-gradient-to-tr from-crust via-base to-crust drop-shadow-xl py-4'>
                <div className='animate-appearEvenLonger md:flex justify-center'>
                    ...
                    <div className='text-center justify-center my-auto md:mx-0 mx-auto py-4 md:px-3 px-2 text-medium tracking-wider md:w-1/3 w-5/6 rounded-lg transition duration-500 hover:bg-crust'>
                        ...
                        <p className='text-lg'>
                            the OOCQC thread became instantly popular from
                            people treating it as the new quotes forum. Later
                            that year, in August, she created the OOCQC resource
                            pack, and released the first version shortly after.
                        </p>
                        <p className='text-lg my-4'>
                            ...
                            resource pack. She also created this very website
                            you're on.
                        </p>
                    </div>
                </div>
